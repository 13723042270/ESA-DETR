...
if __name__ == '__main__':
    model_path ='runs/train/rtdetr-ESA-csdb/weights/best.pt'

    model = RTDETR(model_path)
    # result = model.val(data=r'/root/autodl-tmp/datasets/TTK110/TTK110.yaml',
    result = model.val(data=r'/root/autodl-tmp/datasets/CCTSDB2021/CCTSDB.yaml',
